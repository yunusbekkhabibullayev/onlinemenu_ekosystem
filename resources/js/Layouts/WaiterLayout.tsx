...
const navigation = [
    { name: 'Stollar', href: '/waiter/tables', icon: TableIcon },
    { name: 'Faol buyurtmalar', href: '/waiter/orders/active', icon: ShoppingBag },
];
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            >
                ...
                <div className="flex items-center justify-between h-16 px-4 border-b border-gray-800">
                    <Link href="/waiter/tables" className="flex items-center gap-2">
                        <div className="w-8 h-8 rounded-lg bg-primary flex items-center justify-center">
                            <UtensilsCrossed className="w-5 h-5 text-white" />
                        </div>
                        <div>
                            <span className="text-base font-bold text-white block leading-tight">Ofitsiant</span>
                            <span className="text-xs px-1.5 py-0.5 rounded bg-blue-500/20 text-blue-400 font-medium">Panel</span>
                        </div>
                    </Link>
                    <button
                        onClick={() => setSidebarOpen(false)}
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="flex items-center gap-2">
                                ...
                                <span className="hidden sm:inline-block">{user?.name || 'Ofitsiant'}</span>
