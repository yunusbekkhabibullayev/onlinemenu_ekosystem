...
const navigation = [
    ...
    { name: 'Buyurtmalar navbat', href: '/kitchen/orders', icon: List },
];
            ...
            >
                ...
                <div className="flex items-center justify-between h-16 px-4 border-b border-gray-800">
                    <Link href="/kitchen/dashboard" className="flex items-center gap-2">
                        ...
                        <div>
                            <span className="text-base font-bold text-white block leading-tight">Oshxona</span>
                            <span className="text-xs px-1.5 py-0.5 rounded bg-violet-500/20 text-violet-400 font-medium">Panel</span>
                        </div>
                    </Link>
                    <button
                        onClick={() => setSidebarOpen(false)}
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" className="flex items-center gap-2">
                                ...
                                <span className="hidden sm:inline-block">{user?.name || 'Oshxona'}</span>
